...
@Component({
    ...
    standalone: true,
    imports: [TopHeaderComponent, NavbarComponent, CategoriesComponent, AboutComponent, FeaturedJobsComponent, HowAbezoWorksComponent, WhyJoinUsComponent, SuccessStoriesComponent, PartnersComponent, BlogComponent, DownloadAppComponent, CtaComponent, FooterComponent, BackToTopComponent],
